...
import worker from "/home/bert/orbis/catalyst/apps/catalyst_gql_api/.wrangler/tmp/bundle-R7JS4y/middleware-insertion-facade.js";
import {
	__facade_invoke__,
	__facade_register__,
	Dispatcher,
	Middleware,
} from "/home/bert/orbis/catalyst/node_modules/.pnpm/wrangler@3.31.0_@cloudflare+workers-types@4.20240222.0/node_modules/wrangler/templates/middleware/common.ts";

// We need to preserve all of the exports from the worker
export * from "/home/bert/orbis/catalyst/apps/catalyst_gql_api/.wrangler/tmp/bundle-R7JS4y/middleware-insertion-facade.js";

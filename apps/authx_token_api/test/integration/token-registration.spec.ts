 ...
 *
 * Validates:
 * - FR-001: All tokens are registered before signing
 * - FR-005: Registry uses jwt.jti as the ID
 * - FR-011: Unregistered tokens fail authentication
 */
describe('Integration: Token Registration', () => {
	...
	describe('FR-006: Deleted Token Authentication', () => {
		it('should fail authentication when token is deleted from registry', async () => {
			...
			// ═══════════════════════════════════════════════════════════
			// STEP 7: Attempt to validate the deleted token (FR-006)
			// ═══════════════════════════════════════════════════════════

/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 66dca3cbc5c9e0939446befc7dd7ac45)
// Runtime types generated with workerd@1.20250525.0 2025-04-01 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		KEY_PROVIDER: DurableObjectNamespace<import('./src/index').JWTKeyProvider>;
		AUTHZED: Fetcher /* authx_authzed_api */;
		DATA_CHANNEL_REGISTRAR: Fetcher /* data_channel_registrar */;
		USERCACHE: Fetcher /* user-credentials-cache */;

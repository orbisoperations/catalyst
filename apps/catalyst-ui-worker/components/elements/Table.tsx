...
export const OrbisTable = (props: OrbisTableProps) => {
    const { headers, rows, caption, tableProps, enableHover, containerProps } = props;
    return rows && rows.length > 0 ? (
        ...
        <OrbisCard>No Content available</OrbisCard>
    );
};
                            ...
                            <Td>
                                <Checkbox
                                    ...
                                    onChange={() => {
                                        ...
                                        const target = tmpSelections.findIndex((index) => index === i);
                                        if (target !== -1) {

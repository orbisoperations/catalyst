// Generated by Wrangler by running `wrangler types` (hash: 6fa3e1fe2234a3f13abfb1898550520f)
// Runtime types generated with workerd@1.20250408.0 2025-04-01 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		ENVIRONMENT: "preview" | "staging" | "demo" | "production";
		SERVICE_NAME: "catalyst/preview/user-credentials-cache" | "catalyst/staging/user-credentials-cache" | "catalyst/demo/user-credentials-cache" | "catalyst/production/user-credentials-cache";
		CACHE: DurableObjectNamespace<import("./src/index").UserCredsCache>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "SERVICE_NAME">> {}
}
